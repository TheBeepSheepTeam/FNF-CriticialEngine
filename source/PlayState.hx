...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		scoreTxt.text = "Score:" + songScore + " | " + "Misses:" + songMisses + " | " + "Health:" + health;
	...
	{
		var leftBP = controls.NOTE_LEFT_P;
		var downBP = controls.NOTE_DOWN_P;
		var upBP = controls.NOTE_UP_P;
		var rightBP = controls.NOTE_RIGHT_P;
